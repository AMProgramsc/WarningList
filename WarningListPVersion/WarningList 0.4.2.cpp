...
void intro()
{
	...
	cout << "\t\t\t\t|WarningList 0.4.2 BASIC    |" << endl;
...
int main()
{
	...
	int fix;
	int Delete;
	int enter1 = 0, enter2, enter3 = 0 ,enter4 , enter5 = 0,enter6 = 0;
	double warning = 0;
	...
	while (enter1 != 1)
	{
		...
		else if (enter1 == 4)
		{
			...
			case 1:
				...
				cout << "\t\t\t |Version - 0.4.2 Basic                              |" << endl;
				cout << "\t\t\t |id - 04052021                                      |" << endl;
				cout << "\t\t\t |Information:                                       |" << endl;
				cout << "\t\t\t |Fixed - dynamic array d_syze is now vector         |" << endl;
				cout << "\t\t\t |Fixed - eternal cycle while(exit)                  |" << endl;
				cout << "\t\t\t |                                                   |" << endl;
				cout << "\t\t\t .---------------------------------------------------." << endl;
				BackEvent(enter3);
				cin >> enter1;
