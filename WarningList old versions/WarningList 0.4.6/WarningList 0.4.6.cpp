...
void intro()
{
	...
	cout << "\t\t\t\t|WarningList 0.4.6 BASIC    |" << endl;
	...
	while (enter1 != 1)
	{
		...
		else if (enter1 == 4)
		{
			...
			case 1:
				...
				cout << "\t\t\t |Version - 0.4.6 Basic                              |" << endl;
				cout << "\t\t\t |id - 28052021                                      |" << endl;
				cout << "\t\t\t |Information:                                       |" << endl;
				cout << "\t\t\t |Full Added - save and delete information in file   |" << endl;
				cout << "\t\t\t |                                                   |" << endl;
				cout << "\t\t\t |                                                   |" << endl;
				cout << "\t\t\t .---------------------------------------------------." << endl;
				BackEvent(enter3);
	...
	*/
	...
	if (savedata == 1)
	{
		...
		else
		{
			...
			fe << ".------------------------------" << endl;
			fe << "Version: " << "0.4.6 BASIC" << endl;
			fe << "Programm running time: " << clock() << "/sec" <<endl;
		}
		fs.close();
		fe.close();
	}
