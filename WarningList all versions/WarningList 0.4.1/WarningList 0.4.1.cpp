...
void intro()
{
	...
	cout << "\t\t\t\t|WarningList 0.4.1 BASIC    |" << endl;
	...
	while (enter1 != 1)
	{
		...
		else if (enter1 == 4)
		{
			...
			case 1:
				...
				cout << "\t\t\t |Version - 0.4.1 Basic                              |" << endl;
				cout << "\t\t\t |id - 30042021                                      |" << endl;
				cout << "\t\t\t |Information:                                       |" << endl;
				cout << "\t\t\t |Added - elements of the array can be deleted       |" << endl;
				cout << "\t\t\t |Fixed - Colors returned!                           |" << endl;
				cout << "\t\t\t |                                                   |" << endl;
				cout << "\t\t\t .---------------------------------------------------." << endl;
				BackEvent(enter3);
				cin >> enter1;
