...
void introR()
{
	...
	cout << "\t\t\t\t|WarningList 0.3 BASIC      |" << endl;
...
int Translite()
{
	...
	while (enter1 != 1)
	{
		...
		else if (enter1 == 4)
		{
			...
			case 1:
				...
				cout << "\t\t\t |Версия - 0.3 Basic                              |" << endl;
				cout << "\t\t\t |id - 22032021                                   |" << endl;
				cout << "\t\t\t |Информация:                                     |" << endl;
				cout << "\t\t\t |Добавленно - Крупное обновление: Теперь можно см|" << endl;
				cout << "\t\t\t |енить Английский язык на русский и обратно.     |" << endl;
				cout << "\t\t\t .------------------------------------------------." << endl;
				BackEventR(enter3);
				cin >> enter1;
				break;
	...
	*/
	...
	for (int c = 0; c < size; c++)
	{
		...
		cout << "|Твоё имя: " << user.name << endl;
		cout << "|Твоя Фамилия: " << user.family << endl;
		cout << "|Твой ID - " << user.GetID() << endl;
		cout << "._____________________________." << endl;
