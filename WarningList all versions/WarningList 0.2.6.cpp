...
int main()
{
	...
	if (enter1 == 3)
	{
		...
		case 1:
			...
			cout << "\t\t\t |Version - 0.2.6 Basic                           |" << endl;
			cout << "\t\t\t |Information:                                    |" << endl;
			cout << "\t\t\t |Added - information menu                        |" << endl;
			cout << "\t\t\t |Added - recomendations                          |" << endl;
			cout << "\t\t\t |Added - Corrected number,if the number was wrong|" << endl;
			cout << "\t\t\t |Fixed - SetColor error                          |" << endl;
			cout << "\t\t\t .------------------------------------------------." << endl;
			cout << "1)Start" << endl;
			cout << "2)Exit" << endl;
			cin >> enter1;
	...
	cout << "WarningList 0.2.5 BASIC" << endl;
